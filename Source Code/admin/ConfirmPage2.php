    ...
    <body>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
            ...
            <ul id="SideArea" class="nav nav-pills nav-stacked">
                ...
                <li  class="active"><a href="ConfirmPage2.php">
       ...
       <br><br><br>         <h2 class="alert alert-danger">ARE YOU SURE- <br>GOING TO BEGIN A NEW SEM?</h2>
                <br><br><br>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                <a href="DeleteData.php"><input type="button" class="btn btn-success btn-lg" value="CONFIRM"></a>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 col-xs-2"></div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 col-xs-3">
...
/*        DEVELEPOR NOTES(R*)
                _______________
1) This page is for Conforming the request for Changing the SEM with same class i.e., Moving from SEM1-SEM-2;
2) We redirect to DeleteData.php;
*/
?>